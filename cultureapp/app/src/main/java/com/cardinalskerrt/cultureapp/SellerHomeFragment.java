...
public class SellerHomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnOnUpdateFeed = getActivity().findViewById(R.id.imgbtn_update_feed);
        btnOnUpdateFeed.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
//                Toast.makeText(SellerScreenActivity.this, "Hello", Toast.LENGTH_SHORT).show();
            }
        });
